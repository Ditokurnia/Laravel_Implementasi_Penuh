@php
    $styleHeadMain =
        'border: 1px solid black; vertical-align: center; text-align: center; font-weight: 500; font-size: 12px; width: 25px; height: 50px;';
    ...
    <tbody>
        @foreach ($products as $product)
            <tr>
                ...
                <td style="{{ $styleBodyMain }}">{{ $product->price }}</td>
